...
def generate_input(m: int, n: int, k: int, l: int, seed: int):
    ...
    a_ref = torch.randint(-128, 128, (l, m, k // 2), dtype=torch.int8, device="cuda").permute(1, 2, 0)
    b_ref = torch.randint(-128, 128, (l, n, k // 2), dtype=torch.int8, device="cuda").permute(1, 2, 0)
